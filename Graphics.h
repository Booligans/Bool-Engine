...
//Loads a sprite | PARAMETERS: Sprite, file load location.
void loadSprite(ALLEGRO_BITMAP * &image, std::string location);
//Saves a sprite. Returns true if the image has been saved successfully | PARAMETERS: Sprite, file save location.
...
void showScreen();
//Destroy the sprite, freeing al the memmory and resources used by it, also lets the pointer to nullptr. PARAMETERS: Sprite.
